...
const Navbar: FC = () => {
  return (
    <>
      <nav className="bg-zinc-50 dark:bg-zinc-800 p-4 rounded-2xl border-b border-zinc-500">
      ...
      <div className="px-32">
        <div className="flex items-center justify-center p-1 bg-zinc-50 dark:bg-zinc-800 rounded-b-xl min-w-md border-b border-zinc-500">
